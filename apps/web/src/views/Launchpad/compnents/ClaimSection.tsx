...
import { displayNumber, getContractResult } from 'utils/eldenHelper'
    ...
    <Container>
      <Flex flexDirection="column">
        <Flex alignItems="center" style={{ gap: 15 }}>
          <SpinnerWrapper>
            <SpinnerInner>
              <Image src="/efi/dividen.svg" width={30} height={30} alt="" />
            </SpinnerInner>
          </SpinnerWrapper>
      ...
      <EBox>
        <Flex flexDirection="column" style={{ gap: 4 }}>
          ...
          {!launchData.claimed && (
            <EButton handleClick={handleClaim} disabled={isTxLoading || !launchData.expectedClaim1Amount}>
              Claim Tokens
            </EButton>
          )}
          {launchData.claimed && (
