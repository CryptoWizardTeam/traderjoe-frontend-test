...
const BoosterModal: React.FC<React.PropsWithChildren<BoosterModalProps>> = ({
  ...
  return (
    <Modal title={`Boost your position`} onDismiss={onDismiss}>
      <Text fontSize="20px" textAlign="center">
        {data.name} {data.type.toLocaleLowerCase()} esNFT
      </Text>
      ...
      <Flex justifyContent="space-around" mt={12}>
        {tab === 'boost' ? (
          ...
          <EButton handleClick={handleUnboost} disabled={!amount || isLoading || amount > data.boostPoints} style={{ marginTop: 5 }}>
