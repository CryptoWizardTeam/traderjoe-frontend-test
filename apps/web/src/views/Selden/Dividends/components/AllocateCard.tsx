    ...
    <CardContent>
      ...
      <Flex flexDirection="column" width="100%" style={{ gap: 12 }}>
        <Flex justifyContent="space-between">
          ...
          <span>{Number(props.data.allocated.toFixed(4))} sGGTORO</span>
        </Flex>
        <Flex justifyContent="space-between">
        ...
        <Flex justifyContent="space-between">
          ...
          <span>{Number(props.data.manualAllocation.toFixed(4))} sGGTORO</span>
        </Flex>
        <Flex justifyContent="space-between">
          <span style={{ color: 'gray' }}>Redeem allocation</span>
          <span>{Number(props.data.redeemAllocation.toFixed(4))} sGGTORO</span>
        </Flex>
      </Flex>
