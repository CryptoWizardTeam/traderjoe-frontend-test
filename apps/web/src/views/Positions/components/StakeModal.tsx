...
export const StakeModal: React.FC<React.PropsWithChildren<StakeModalProps>> = ({
  ...
  return (
    <Modal title={'Stake into a GoodGame Pool'} onDismiss={onDismiss}>
      ...
      <Flex justifyContent="space-around" mt={12}>
        <EButton handleClick={handleStake} disabled={!selectedRunePool} isLoading={isLoading} style={{ marginTop: 5 }}>
