          ...
          <Flex justifyContent="space-between" mb="16px" flexDirection={['column', 'column', 'row']}>
            <Breadcrumbs mb="32px">
              <NextLinkFromReactRouter to={`/${v3InfoPath}${chainPath}${infoTypeParam}`}>
                <Text color="primary" fontSize={16} fontWeight={400}>
                  {t('Info')}
                </Text>
              </NextLinkFromReactRouter>
          ...
          <Flex flexDirection="column">
            <Flex alignItems="center" mb={['8px', null]}>
              <DoubleCurrencyLogo
                ...
                chainName={chainName}
              />
              <Text ml="20px" fontSize={'20px'} fontWeight={300} id="info-pool-pair-title">
                {`${poolData.token0.symbol} / ${poolData.token1.symbol}`}{' '}
                <GreyBadge ml="4px" style={{ display: 'inline-block' }}>
                  {feeTierPercent(poolData.feeTier)}
                </GreyBadge>
            ...
            <Flex justifyContent="space-between" flexDirection={['column', 'column', 'column', 'row']}>
                ...
                >
                  <TokenButton>
                    ...
                    >
                      ...
                      {` ${formatAmount(poolData.token1Price, {
                        notation: 'standard',
                ...
                >
                  <TokenButton ml={[null, null, '10px']}>
                    ...
                    >
                      ...
                      {` ${formatAmount(poolData.token0Price, {
                        notation: 'standard',
                        displayThreshold: 0.001,
                        tokenPrecision: hasSmallDifference ? 'enhanced' : 'normal',
              ...
              <Flex style={{ gap: '10px' }}>
                ...
                >
                  <EOutlineButton>{t('Add Liquidity')}</EOutlineButton>
                </NextLinkFromReactRouter>
                <NextLinkFromReactRouter
                ...
                >
                  <EOutlineButton>{t('Trade')}</EOutlineButton>
                </NextLinkFromReactRouter>
              </Flex>
            </Flex>
          </Flex>
          <ContentLayout>
            <EBox>
              ...
              <Flex mb="20px" justifyContent="space-between">
                <Text lineHeight={1.3} color="app" fontWeight={400}>
                  {t('TVL')}
                </Text>
                <Flex flexDirection="column">
            ...
            <EBox>
              ...
              <Flex flexDirection="column" px="24px" pt="24px">
                ...
                <Text small color="secondary" fontWeight={300}>
