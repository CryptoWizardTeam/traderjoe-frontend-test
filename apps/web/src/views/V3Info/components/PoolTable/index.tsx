        ...
        <Text fontSize={14} fontWeight={300}>
          <RowFixed>
            <DoubleCurrencyLogo
              ...
              chainName={chainName}
            />
            <Text ml="8px" fontSize={14} fontWeight={300}>
            ...
            <GreyBadge ml="10px" style={{ fontSize: 14, background: '#051005' }}>
  ...
  return (
    <TableWrapper>
      {sortedPools.length > 0 ? (
        <>
          <ResponsiveGrid>
            <Text color="gray6" fontSize={14} fontWeight={300}>
              #ID
            </Text>
          ...
          <PageButtons>
            ...
            <Text fontSize={14} fontWeight={400}>{`Page ${page} of ${maxPage}`}</Text>
            <Box
              onClick={() => {
