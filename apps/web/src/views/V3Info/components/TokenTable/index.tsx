      ...
      <ResponsiveGrid>
        ...
        <Flex>
          ...
          <Text style={{ marginLeft: '10px' }}>
            <RowFixed>
              {isMobile ? (
                <HoverInlineText fontSize="14px" text={tokenData.symbol} />
              ) : (
                <HoverInlineText fontSize="14px" text={tokenData.name} />
              )}
              {!isMobile && (
                <Text ml="8px" color={theme.colors.text} fontSize={14} fontWeight={300}>
                  ({tokenData.symbol})
                </Text>
              )}
            </RowFixed>
        ...
        <Text fontSize={14} fontWeight={300}>
          <Percent value={tokenData.priceUSDChange} fontSize='14px' fontWeight={300} />
        </Text>
        <Text fontSize={14} fontWeight={300}>
  ...
  return (
    <TableWrapper>
      {sortedTokens.length > 0 ? (
        <AutoColumn gap="16px">
          <ResponsiveGrid>
            <Text color="gray6" fontSize={13} fontWeight={300}>
              #ID
            </Text>
            <ClickableColumnHeader color="gray6" fontSize={14} fontWeight={300}>
              {t('Name')}
              <SortButton
                scale="sm"
                variant="subtle"
          ...
          <PageButtons>
            ...
            <Text fontSize={14} fontWeight={300}>{`Page ${page} of ${maxPage}`}</Text>
            <Box
              onClick={() => {
