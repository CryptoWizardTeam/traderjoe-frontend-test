    ...
    <Page>
      ...
      >
        ...
        <Grid gridTemplateColumns="1fr 1fr" width="100%" style={{ gap: 16 }}>
          <RewardCard icon={'/efi/icons/mingcute_coin-2-fill.png'} title={'earning rewards'} value={0} />
          <RewardCard icon={'/efi/icons/ri_fire-line.png'} title={'nitro rewards'} value={0} />
        </Grid>
      </Flex>
    </Page>
  )
