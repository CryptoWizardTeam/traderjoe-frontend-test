    ...
    <FlexGap gap="16px" width="100%">
      <StepCounter
        ...
        title={
          currencyA &&
          currencyB &&
          t('Min %assetA% per %assetB% price', { assetA: currencyB?.symbol, assetB: currencyA?.symbol })
        }
        tokenA={currencyA}
        tokenB={currencyB}
      />
      <StepCounter
        ...
        title={
          currencyA &&
          currencyB &&
          t('Max %assetA% per %assetB% price', { assetA: currencyB?.symbol, assetB: currencyA?.symbol })
        }
      />
    </FlexGap>
  )
