    ...
    <TransactionConfirmationModal
      ...
      content={() => (
        <ConfirmationModalContent
          ...
          bottomContent={() => (
            <EButton handleClick={onAdd} style={{ width: '100%', marginTop: '16px' }}>
              {t('Add')}
            </EButton>
          )}
        />
        ...
        <AutoColumn gap="16px">
          ...
          {noLiquidity && (
            <Box>
              ...
              <AutoRow justifyContent="space-between" mb="24px" mt="12px">
                <Text fontSize="13px">{t('Current %symbol% Price', { symbol: baseCurrency?.symbol })}:</Text>
                <Text fontSize="13px">
