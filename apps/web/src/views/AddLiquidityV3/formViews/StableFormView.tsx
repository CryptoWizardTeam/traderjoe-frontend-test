      ...
      <RightContainer>
        <AutoColumn>
          <Box mt="8px">
            ...
            <Text fontSize="24px" fontWeight={500} mb="8px" color="app">
              $
              {totalLiquidityUSD
            ...
            <AutoRow justifyContent="space-between" mb="4px">
              <Text fontSize="14px" fontWeight={300} color="textSubtle">
                {t('Price')}:{' '}
              </Text>
            ...
            <AutoRow justifyContent="space-between" mb="4px">
              ...
              <Text fontSize="14px" fontWeight={300}>
                {stableLpFee ? BIG_ONE_HUNDRED.times(stableLpFee).toNumber() : '-'}%
              </Text>
            </AutoRow>
