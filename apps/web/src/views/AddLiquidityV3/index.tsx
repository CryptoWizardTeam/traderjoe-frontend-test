...
import AddESNftLiquidity from 'views/AddLiquidity/AddESNftLiquidity'
...
import ESNftFormView from './formViews/ESNftFormView'
    ...
    <Box mt="8px">
      <ResponsiveTwoColumns>
        <AutoColumn alignSelf="start" mt="8px">
          ...
          <FlexGap gap="8px" width="100%" mb="8px" alignItems="center" flexWrap="wrap" justifyContent="space-between">
            <CurrencySelect
              ...
              hideBalance
            />
            <Image src="/efi/icons/arrow-exchange.svg" width={32} height={32} alt="arrow" />
            <CurrencySelect
        ...
        {selectorType === SELECTOR_TYPE.ESNFT && (
          <AddESNftLiquidity currencyA={baseCurrency} currencyB={quoteCurrency}>
            {(props) => <ESNftFormView {...props} />}
          </AddESNftLiquidity>
        )}
      </ResponsiveTwoColumns>
    </Box>
...
const SELECTOR_TYPE_T = {
  ...
  [SELECTOR_TYPE.ESNFT]: <Trans>Add EsNFT Liquidity</Trans>,
