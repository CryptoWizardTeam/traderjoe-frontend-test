  ...
  return (
    <Page>
      <Flex
        ...
        style={{ gap: 16 }}
      >
        {/* TIGER<EPageHeader pageName="gauge" /> */}

        <Flex marginTop={36} flexWrap="wrap" style={{ gap: 12 }} justifyContent="center">
          <Flex style={{ gap: 12 }}>
            <RewardCard>
              <RewardValue>sGGTORO balance</RewardValue>
              <RewardLabel>0 sGGTORO</RewardLabel>
            </RewardCard>
          ...
          <Flex style={{ gap: 12 }}>
            <RewardCard>
              ...
              <RewardLabel>0 GGTORO</RewardLabel>
            </RewardCard>
        ...
        <Flex marginTop={36} flexDirection="column" alignItems="center">
          ...
          <Flex style={{ gap: 4, color: '#72898c', fontSize: 15 }}>
            <span>sGGTORO</span> -<span>Rewards Distributor</span> -<span>Gauge Controller</span>
          </Flex>
        </Flex>
