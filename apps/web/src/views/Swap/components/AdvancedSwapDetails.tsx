...
import { RoutingSettingsButton } from 'components/EMenu/GlobalSettings/SettingsModal'
        ...
        <>
          ...
          {realizedLPFee && (
                ...
                <>
                  ...
                  <Text mt="12px">
                    <Link
                      ...
                      href={
                        isMM
                          ? 'https://docs.elden.fi/products/pancakeswap-exchange/market-maker-integration#fees'
                          : 'https://docs.elden.fi/products/pancakeswap-exchange/faq#what-will-be-the-trading-fee-breakdown-for-v3-exchange'
                      }
                    >
            ...
            /> */}
              ...
              <Text fontSize="12px">{`${formatAmount(realizedLPFee, 4)} ${inputAmount?.currency?.symbol}`}</Text>
            </RowBetween>
          )}
        </>
      )}
