...
export const RouterPoolBox = styled(Box)`
  ...
  flex-direction: row;
  padding: 2px 4px;
  background: linear-gradient(180deg, rgba(202, 255, 51, 0.25) -66.22%, rgba(202, 255, 51, 0) 85.46%);
  z-index: 2;
  svg,
  img {
    &:first-child {
  ...
  &.isStableSwap,
  &.highlight {
    background: linear-gradient(180deg, rgba(202, 255, 51, 0.55) -66.22%, rgb(202 255 51 / 6%) 85.46%); // ${({
      theme,
...
`
export const CurrencyLogoInner = styled.div`
  position: relative;
  padding: 5px;
  background: linear-gradient(180deg, rgba(202, 255, 51, 0.12) -66.22%, rgba(202, 255, 51, 0) 85.46%);
  border-radius: 50%;
`
