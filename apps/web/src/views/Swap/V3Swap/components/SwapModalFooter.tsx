    ...
    <>
                  ...
                  <>
                    ...
                    <Text mt="12px">
                      ...
                      <Link
                        ...
                        ml="4px"
                        external
                        href="https://docs.elden.fi/products/stableswap#stableswap-fees"
                      >
                        {t('here.')}
                      </Link>
                    </Text>
                  ...
                  <>
                    ...
                    <Text mt="12px">
                      <Link
                        ...
                        ml="4px"
                        external
                        href="https://docs.elden.fi/products/pancakeswap-exchange/faq#what-will-be-the-trading-fee-breakdown-for-v3-exchange"
                      >
      ...
      <AutoRow>
        <EButton
          ...
          style={{ marginTop: '12px', color: 'white', width: '100%' }}
        >
          {isMM && !isRFQReady ? (
