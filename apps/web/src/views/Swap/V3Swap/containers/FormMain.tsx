...
import CurrencyInputPanel from 'components/ECurrencyInputPanel'
...
export function FormMain({ tradeDetails, inputAmount, outputAmount, tradeLoading, swapCommitButton }: Props) {
