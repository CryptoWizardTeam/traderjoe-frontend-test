...
import SettingsModal, {
  ...
  withCustomOnDismiss,
} from 'components/EMenu/GlobalSettings/SettingsModal'
        ...
        style={{
          background:
            isValid && priceImpactSeverity > 2 && !swapCallbackError
              ? 'linear-gradient(90deg, rgb(231, 236, 3) 0%, rgb(240 41 41) 45%)'
              : 'linear-gradient(90deg, #E7EC03 -24.18%, #29F069 70.82%)',
        }}
      >
        {swapInputError ||
