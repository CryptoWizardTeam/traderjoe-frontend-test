...
interface ConfirmAddESNftLiquidityModalProps {
  title: string
...
const ConfirmAddESNftLiquidityModal: React.FC<
  React.PropsWithChildren<InjectedModalProps & ConfirmAddESNftLiquidityModalProps>
> = ({
  title,
  onDismiss,
  customOnDismiss,
  ...
  const modalBottom = useCallback(() => {
    return (
      <>
        <AutoColumn gap="20px" width="100%" mt="20px">
        ...
        <EButton style={{ width: '100%', marginTop: '20px' }} handleClick={onAdd}>
...
export default ConfirmAddESNftLiquidityModal
