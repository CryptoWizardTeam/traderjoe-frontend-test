...
export const POOLS_FAST_REVALIDATE = {
  ...
  [ChainId.SEPOLIA]: 20_000, // messi-sepolia
  [ChainId.POLYGON]: 20_000, // messi-polygon
  [ChainId.BITCOIN]: 20_000, // messi-bitcoin
...
export const POOLS_SLOW_REVALIDATE = {
  ...
  [ChainId.SEPOLIA]: 40_000, // messi-sepolia
  [ChainId.POLYGON]: 40_000, // messi-polygon
  [ChainId.BITCOIN]: 40_000, // messi-bitcoin
