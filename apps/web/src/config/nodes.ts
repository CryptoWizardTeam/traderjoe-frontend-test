...
import { arbitrum, polygonZkEvm, zkSync, zkSyncTestnet, polygonZkEvmTestnet, arbitrumGoerli, base, sepolia, /* messi-sepolia */
polygon /* messi-polygon */} from 'wagmi/chains'
import { getNodeRealUrlV2 } from 'utils/nodeReal'
import { opbnbTestnet, linea, opbnb, scroll, scrollSepolia, baseGoerli, bitcoin } from './chains'
...
export const SERVER_NODES = {
  ...
  [ChainId.SEPOLIA]: sepolia.rpcUrls.public.http, // messi-sepolia
  [ChainId.POLYGON]: polygon.rpcUrls.public.http, // messi-polygon
  [ChainId.BITCOIN]: bitcoin.rpcUrls.public.http, // messi-bitcoin
