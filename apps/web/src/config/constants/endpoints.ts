...
export const BLOCKS_CLIENT_GOERLI = 'https://api.studio.thegraph.com/query/60345/ggtoro-blocks/version/latest' // messi
export const BLOCKS_CLIENT_SEPOLIA = 'https://api.studio.thegraph.com/query/60345/ggtoro-blocks-sepolia/version/latest' // messi-sepolia
export const BLOCKS_CLIENT_POLYGON = 'https://api.studio.thegraph.com/query/66250/ggtoro-blocks/version/latest' // messi-polygon
export const BLOCKS_CLIENT_BITCOIN = '' // messi-bitcoin
...
// export const STABLESWAP_SUBGRAPH_CLIENT = 'https://api.studio.thegraph.com/query/60345/ggtoro-stableswap/version/latest' // messi
export const STABLESWAP_SUBGRAPH_CLIENT = 'https://api.studio.thegraph.com/query/66250/ggtoro-stableswap/version/latest' // messi-polygon
// export const STABLESWAP_SUBGRAPH_CLIENT = 'https://api.studio.thegraph.com/query/60345/ggtoro-stableswap-sepolia/version/latest' // messi-sepolia
...
export const INFO_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.GOERLI]: 'https://api.studio.thegraph.com/query/60345/ggtoro-positions/version/latest', // messi
  [ChainId.SEPOLIA]: 'https://api.studio.thegraph.com/query/60345/ggtoro-positions-sepolia/version/latest', // messi-sepolia
  [ChainId.POLYGON]: 'https://api.studio.thegraph.com/query/66250/ggtoro-positions/version/latest', // messi-polygon
  [ChainId.BITCOIN]: '', // messi-bitcoin
...
export const ASSET_CDN = 'https://ucarecdn.com'

export const V3_SUBGRAPH_URLS = {
  [ChainId.ETHEREUM]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exchange-v3-eth',

  // [ChainId.GOERLI]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/exchange-v3-goerli',
  [ChainId.GOERLI]: 'https://api.studio.thegraph.com/query/60345/ggtoro-v3/version/latest', // messi
  [ChainId.SEPOLIA]: 'https://api.studio.thegraph.com/query/60345/ggtoro-v3-sepolia/version/latest', // messi-sepolia
  [ChainId.POLYGON]: 'https://api.studio.thegraph.com/query/66250/ggtoro-v3/version/latest', // messi-polygon
  [ChainId.BITCOIN]: '', // messi-bitcoin
