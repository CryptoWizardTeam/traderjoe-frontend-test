...
export default function PoolPage() {
  ...
  const isStakedInMCv3 = false // tokenId && Boolean(stakedTokenIds.find((id) => id === tokenId))
                  ...
                  <Flex alignItems="center">
                    ...
                    {!isMobile && (
                      <>
                        ...
                        <RangeTag ml="8px" removed={removed} outOfRange={!inRange} outline />
                      </>
                    )}
                  </Flex>
            ...
            <CardBody>
              ...
              <AutoRow>
                ...
                >
                  <Box width="100%" mb={['8px', '8px', 0]} position="relative">
                    ...
                    <Text fontSize="15px" color="secondary" fontWeight={300}>
                      {t('Liquidity')}
                    </Text>

                    <Text fontSize="20px" fontWeight={600} mb="8px" color="app">
                      $
              ...
              <AutoRow mb="8px">
                ...
                >
                  ...
                  {isMobile ? null : (
                    <Image
                      src="/efi/icons/arrow-exchange.svg"
                      width={32}
                      height={32}
...
function PositionHistory_({
  ...
  return (
    <AtomBox textAlign="center" pt="16px" justifyContent="center" display="flex" flexDirection="column" gap="16px">
      <EButtonSm
  ...
  if (isMobile) {
    return (
      <Box>
        ...
        <Text fontWeight={200}>{positionHistoryTypeText[type]}</Text>
        <AutoColumn gap="4px">
          {+positionTx.amount0 > 0 && (
            <AutoRow flexWrap="nowrap" gap="12px" justifyContent="space-between">
              ...
              <Text ellipsis title={positionTx.amount0} fontWeight={300}>
          ...
          {+positionTx.amount1 > 0 && (
            <AutoRow flexWrap="nowrap" gap="12px" justifyContent="space-between">
              ...
              <Text ellipsis title={positionTx.amount1} fontWeight={300}>
