...
export default function StablePoolPage() {
  ...
  const poolTokenPercentage = usePoolTokenPercentage({ userPoolBalance, totalPoolTokens })
      ...
      <BodyWrapper>
        ...
        <CardBody>
          ...
          <Text color="textSubtle">
            {t('Your share in pool')}: {poolTokenPercentage ? <>{Number(poolTokenPercentage.toFixed(8))}%</> : '-'}
          </Text>
        </CardBody>
      </BodyWrapper>
    </Page>
