...
const SWAP_INFO_BY_CHAIN = {
  ...
  [ChainId.GOERLI]: {
    v3: V3_SUBGRAPH_URLS[ChainId.GOERLI], // messi
  },
  [ChainId.SEPOLIA]: {
    v3: V3_SUBGRAPH_URLS[ChainId.SEPOLIA], // messi-sepolia
  },
  [ChainId.POLYGON]: {
    v3: V3_SUBGRAPH_URLS[ChainId.POLYGON], // messi-polygon
  },
  [ChainId.BITCOIN]: {
    v3: V3_SUBGRAPH_URLS[ChainId.BITCOIN], // messi-bitcoin
  },
