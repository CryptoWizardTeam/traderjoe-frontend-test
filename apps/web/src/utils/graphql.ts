...
export const v3Clients = {
  ...
  [ChainId.SEPOLIA]: new GraphQLClient(V3_SUBGRAPH_URLS[ChainId.SEPOLIA]), // messi-sepolia
  [ChainId.POLYGON]: new GraphQLClient(V3_SUBGRAPH_URLS[ChainId.POLYGON]), // messi-polygon
...
export const v2Clients = {
  ...
  [ChainId.GOERLI]: new GraphQLClient(INFO_CLIENT_WITH_CHAIN[ChainId.GOERLI]), // messi
  [ChainId.SEPOLIA]: new GraphQLClient(INFO_CLIENT_WITH_CHAIN[ChainId.SEPOLIA]), // messi-sepolia
  [ChainId.POLYGON]: new GraphQLClient(INFO_CLIENT_WITH_CHAIN[ChainId.POLYGON]), // messi-polygon
  ...
  [ChainId.BASE_TESTNET]: new GraphQLClient(INFO_CLIENT_WITH_CHAIN[ChainId.BASE_TESTNET]),
  [ChainId.SCROLL]: new GraphQLClient(INFO_CLIENT_WITH_CHAIN[ChainId.SCROLL]),
  [ChainId.SCROLL_SEPOLIA]: new GraphQLClient(INFO_CLIENT_WITH_CHAIN[ChainId.SCROLL_SEPOLIA]),
}
