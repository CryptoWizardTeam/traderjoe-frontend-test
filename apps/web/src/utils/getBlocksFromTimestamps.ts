...
export const getBlocksFromTimestamps = async (
  ...
  // chainName: MultiChainNameExtend | undefined = 'GOERLI', // messi
  chainName: MultiChainNameExtend | undefined = 'POLYGON', // messi-polygon
  // chainName: MultiChainNameExtend | undefined = 'SEPOLIA', // messi-sepolia
): Promise<Block[]> => {
