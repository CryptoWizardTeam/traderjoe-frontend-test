...
// import { SUPPORT_ONLY_BASE } from 'config/constants/supportChains'
// import { SUPPORT_ONLY_GOERLI } from 'config/constants/supportChains' // messi
// import { SUPPORT_ONLY_SEPOLIA } from 'config/constants/supportChains' // messi-sepolia
import { SUPPORT_ONLY_POLYGON } from 'config/constants/supportChains' // messi-polygon
...
export const NetworkModal = ({ pageSupportedChains = SUPPORT_ONLY_POLYGON }: { pageSupportedChains?: number[] }) => { // messi-sepolia
  ...
  const isScrollOnlyPage = useMemo(() => {
    return (
      pageSupportedChains?.length === 1 &&
      (pageSupportedChains[0] === ChainId.POLYGON || pageSupportedChains[0] === ChainId.POLYGON) // messi-sepolia
    )
  }, [pageSupportedChains])
