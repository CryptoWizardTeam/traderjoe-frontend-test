...
const Tabs = styled.div`
  background-color: transparent; //${({ theme }) => theme.colors.dropdown};
...
const TabsComponent: React.FC<React.PropsWithChildren<TabsComponentProps>> = ({ view, handleClick }) => {
  ...
  return (
    <Tabs>
      <CButtonMenu scale="sm" variant="subtle" onItemClick={handleClick} activeIndex={view} fullWidth>
