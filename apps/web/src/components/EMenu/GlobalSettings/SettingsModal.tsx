            ...
            <Flex pb="24px" flexDirection="column">
              ...
              <Flex justifyContent="space-between" alignItems="center" mb="24px">
                <Flex alignItems="center">
                  <Text fontSize="14px">{t('Subgraph Health Indicator')}</Text>
                  <QuestionHelper
                    text={t(
              ...
              <Flex justifyContent="space-between" alignItems="center" mb="24px">
                <Flex alignItems="center">
                  <Text fontSize="14px">{t('Show username')}</Text>
        ...
        {mode === SettingsMode.SWAP_LIQUIDITY && (
          <>
            <Flex flexDirection="column">
              <Text fontSize={16}>{t('Swaps & Liquidity')}</Text>
              <Flex justifyContent="space-between" alignItems="center" mb="24px">
            ...
            <Flex justifyContent="space-between" alignItems="center" /*  mb="24px" */>
              <Flex alignItems="center">
                <Text fontSize="16px">{t('Expert Mode')}</Text>
              </Flex>
              <Toggle
      ...
      <AtomBox textAlign="center">
        <NotificationDot show={isRoutingSettingChange && showRedDot}>
          <EButtonSm
            ...
            scale="sm"
            {...buttonProps}
            style={{ padding: '10px 30px', borderColor: 'rgb(41 240 105 / 50%)' }}
          >
      ...
      >
        <AtomBox>
          ...
          <Flex
            ...
            background="radial-gradient(127.56% 175.14% at 50% 0.6%, rgba(96, 152, 102, 0.05) 0%, rgba(75, 109, 85, 0.00) 100%)"
            borderRadius="8px"
          >
            <Flex alignItems="center">
              <Text>V3</Text>
