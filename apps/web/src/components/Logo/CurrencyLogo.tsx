...
export default function CurrencyLogo({ currency, size = '24px', style }: LogoProps) {
  ...
  if (currency?.isNative) {
    ...
    // return <StyledLogo size={size} srcs={[`${ASSET_CDN}/chains/${currency.chainId}.png`]} width={size} style={style} />
    return <StyledLogo size={size} srcs={[`https://raw.githubusercontent.com/ggtorodefi/assets/main/${currency.chainId}.png`]} width={size} style={style} />
  }
