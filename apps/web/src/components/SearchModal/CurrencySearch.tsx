...
import { Box, Input, Text, useMatchBreakpoints, AutoColumn, Column, AutoRow } from '@pancakeswap/uikit'
...
function CurrencySearch({
  ...
  return (
    <>
      <AutoColumn gap="16px" marginBottom="2px">
        {showSearchInput && (
          <Row>
            <ESearchBox
      ...
      <AutoRow mt="24px">
        <Text fontSize="18px">Token List</Text>
      </AutoRow>
