...
const SHORT_SYMBOL = {
  ...
  [ChainId.GOERLI]: 'GOR',
  [ChainId.SEPOLIA]: 'SEP', // messi-sepolia
  [ChainId.POLYGON]: 'MATIC', // messi-polygon
  [ChainId.BITCOIN]: 'BTC', // messi-bitcoin
  ...
  return (
    <Box ref={cannotChangeNetwork ? targetRef : null} height="100%">
      ...
      <NetworkMenu
        ...
        avatarSrc={`https://raw.githubusercontent.com/ggtorodefi/assets/main/${chainId}.png`}
