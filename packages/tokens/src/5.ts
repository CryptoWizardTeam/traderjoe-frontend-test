...
import { ELDEN, USDC, USDT } from './common' // messi

export const goerliTestnetTokens = {
  weth: WETH9[ChainId.GOERLI], // messi
  elden: ELDEN[ChainId.GOERLI], // messi
  usdc: USDC[ChainId.GOERLI], // messi
  usdt: USDT[ChainId.GOERLI], // messi
