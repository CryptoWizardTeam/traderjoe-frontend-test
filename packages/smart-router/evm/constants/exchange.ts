...
export const SMART_ROUTER_ADDRESSES = {
  ...
  [ChainId.GOERLI]: '0x610af7D9ccC2e635157b40cfDB7286FeE479224a', // messi
  [ChainId.SEPOLIA]: '0xeaD59F147e0226B6A1bb8640d402390e71352f4a', // messi-sepolia
  [ChainId.POLYGON]: '0x86bd701D23A64C25151F0Fe2D2827F62f50B5B31', // messi-polygon
  [ChainId.BITCOIN]: '0x8beD2367ee99bf57C88B292398a80A554A2Cc73f', // messi-bitcoin
...
export const V2_ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.GOERLI]: '0x11f895e3501c2752d178bdF4B5f85BDc193F4007', // messi
  [ChainId.SEPOLIA]: '0x67B874846B6C3D7a63f335eEC9a30D7014E01169', // messi-sepolia
  [ChainId.POLYGON]: '0xf53fd48A7B6C18a97e042CeFF163bA2B8ECd0502', // messi-polygon
  [ChainId.BITCOIN]: '0xb368077212d305af4e6b39C252b5E34fca81b980', // messi-bitcoin
...
export const STABLE_SWAP_INFO_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '',
  [ChainId.GOERLI]: '0xAaf2eBb46374bB5C90fad64f864475Ae03C63586', // messi
  [ChainId.SEPOLIA]: '0x1Ea77118D65D3956579B1e1668Df4bd0974814fF', // messi-sepolia
  [ChainId.POLYGON]: '0x4E88CE58346872A41399525D10CAD317cFba3421', // messi-polygon
  [ChainId.BITCOIN]: '0x2C616F7e187F7a3A5912fEB1A95F5Ed111bb33D5', // messi-bitcoin
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.SEPOLIA]: [sepoliaTestnetTokens.usdt, sepoliaTestnetTokens.usdc, sepoliaTestnetTokens.weth], // messi-sepolia
  [ChainId.POLYGON]: [polygonTokens.usdt, polygonTokens.usdc, polygonTokens.weth], // messi-polygon
  [ChainId.BITCOIN]: [bitcoinTokens.usdt, bitcoinTokens.usdc, bitcoinTokens.weth], // messi-bitcoin
  [ChainId.BSC]: [
    bscTokens.wbnb,
    bscTokens.cake,
    bscTokens.busd,
