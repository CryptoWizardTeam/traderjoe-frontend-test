...
const FACTORY_ADDRESS_ETH = '0x065EE1cBF4d7aE529002B8352777533dC8a2C05A' // messi

export const FACTORY_ADDRESS_MAP = {
  [ChainId.ETHEREUM]: FACTORY_ADDRESS_ETH,
  [ChainId.GOERLI]: "0x065EE1cBF4d7aE529002B8352777533dC8a2C05A", // messi
  [ChainId.SEPOLIA]: "0xCa091Cb7a09D7045b7B162160290a6c63b3DBD70", // messi-sepolia V2 Factory
  [ChainId.POLYGON]: "0xc0DEd88D9D3F2575b8f4BF59aE78D9969E65b27c", // messi-polygon
  [ChainId.BITCOIN]: "0x0c9124c7cDbd487F3f5ce0973491D60828cf05BE", // messi-bitcoin
...
const INIT_CODE_HASH_ETH = '0x56268b4e7939868566001fa5619c6c3683839655684da3534bc0eeb36a41c658' // messi
...
export const INIT_CODE_HASH_MAP = {
  ...
  [ChainId.GOERLI]: '0x56268b4e7939868566001fa5619c6c3683839655684da3534bc0eeb36a41c658', // messi
  [ChainId.SEPOLIA]: '0x22b4962ee7d9222f8a9388276ba775c999d19ae64f57d02fefa47913c151304c', // messi-sepolia
  [ChainId.POLYGON]: '0x22b4962ee7d9222f8a9388276ba775c999d19ae64f57d02fefa47913c151304c', // messi-polygon
  [ChainId.BITCOIN]: '0x22b4962ee7d9222f8a9388276ba775c999d19ae64f57d02fefa47913c151304c', // messi-bitcoin
...
export const WETH9 = {
  ...
  [ChainId.GOERLI]: new ERC20Token(
    ChainId.GOERLI,
    '0x6954a86E4584c2B4132303c9B2f231084481603B', // messi
    18,
    'WETH',
    'Wrapped Ether',
    'https://weth.io'
  ...
  [ChainId.SEPOLIA]: new ERC20Token(
    ChainId.SEPOLIA,
    '0xD7486E46B98aD9888767E2dc96bA96F7aFEeFb2a', // messi-sepolia
    18,
    'WETH',
    'Wrapped Ether',
    'https://weth.io'
  ...
  [ChainId.POLYGON]: new ERC20Token(
    ChainId.POLYGON,
    '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', // messi-polygon
    18,
    'WMATIC',
    'Wrapped Matic',
    ''
  ),
  [ChainId.BITCOIN]: new ERC20Token(
    ChainId.BITCOIN,
    '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', // messi-bitcoin
    18,
    'WETH',
    'Wrapped Ether',
    'https://weth.io'
...
export const WNATIVE = {
  ...
  [ChainId.SEPOLIA]: WETH9[ChainId.SEPOLIA], // messi-sepolia
  [ChainId.POLYGON]: WETH9[ChainId.POLYGON], // messi-polygon
  [ChainId.BITCOIN]: WETH9[ChainId.BITCOIN], // messi-bitcoin
...
export const NATIVE = {
  ...
  [ChainId.SEPOLIA]: ETHER, // messi-sepolia
  [ChainId.POLYGON]: { name: 'Matic', symbol: 'MATIC', decimals: 18 }, // messi-polygon
  [ChainId.BITCOIN]: { name: 'Bitcoin', symbol: 'BTC', decimals: 18 }, // messi-bitcoin
  [ChainId.BSC]: BNB,
  [ChainId.BSC_TESTNET]: {
    name: 'Binance Chain Native Token',
    symbol: 'tBNB',
