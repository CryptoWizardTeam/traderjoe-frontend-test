...
import { AutoColumn, BunnyKnownPlaceholder, ChartDisableIcon, LineGraphIcon, EChartXIcon } from "@pancakeswap/uikit";
...
export function LiquidityChartRangeInput({
  ...
  // Get token color
  const tokenAColor = "#f1f1f1";
  const tokenBColor = "#f1f1f1";
